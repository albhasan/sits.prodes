...
pa_acc_tb %>% 
    ...
    ggplot2::ylim(0, 1) +
    ggplot2::facet_wrap(scene ~ pyear) + 
    ggplot2::labs(title = "SVM smooth_7x7_n10", 
         x = "Producer accuracy", 
         y = "User accuracy")
...
pa_acc_tb %>% 
    ...
    #ggplot2::ylim(0, 1) +
    ggplot2::facet_wrap(scene ~ pyear) +
    labs(title = "rep_prodes_40 - deforestation by algorithm and smooth", 
         x = "Producer accuracy", 
         y = "User accuracy")

pa_acc_tb %>% 
    dplyr::filter(variable == "forest" , experiment == "rep_prodes_40") %>% 
    ggplot2::ggplot(aes(x = prod_acc, y = user_acc, 
                        color = smooth, 
                        shape = algorithm)) +
    ggplot2::geom_point() +
    ...
    ggplot2::ylim(0.9, 1) +
    ggplot2::facet_wrap(scene ~ pyear) +
    labs(title = "rep_prodes_40 - forest by algorithm and smooth", 
         x = "Producer accuracy", 
         y = "User accuracy")
