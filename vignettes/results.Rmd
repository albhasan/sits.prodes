...
# get data for grpahs
acc_tb <- accuracy_tb %>% 
    dplyr::mutate(ua = purrr::map(.$up_acc3, function(x){
        return(x[1:(nrow(x) - 1), ncol(x)])
    }),
    pa = purrr::map(.$up_acc3, function(x){
...
pa_acc_tb %>% 
    ...
    labs(title = "Deep Learning smooth_7x7_n10", 
         x = "Producer accuracy", 
         y = "User accuracy")
pa_acc_tb %>% 
    ...
    ggplot2::geom_point() +
    ggplot2::facet_wrap(scene ~ pyear) + 
    labs(title = "Random Forest smooth_7x7_n10", 
         x = "Producer accuracy", 
         y = "User accuracy")
pa_acc_tb %>% 
    ...
    ggplot2::geom_point() +
    ggplot2::facet_wrap(scene ~ pyear) + 
    labs(title = "Suport Vector Machine smooth_7x7_n10", 
         x = "Producer accuracy", 
         y = "User accuracy")
pa_acc_tb %>% 
    ...
    ggplot2::geom_point() +
    ggplot2::facet_wrap(scene ~ pyear) + 
    labs(title = "Vote DL RF SVM smooth_7x7_n10", 
         x = "Producer accuracy", 
         y = "User accuracy")
